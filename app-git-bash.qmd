...
<span class="col-green">user_id@computer_id</span> is an ID based on name of the user that is logged in, and the name of the device running Git Bash. <span class="col-magenta">MINGW64</span> part is the name of the compiler used to build Git Bash. The <span class="col-yellow">~</span> at the end of the first line indicates the current directory. A tilde means that the current directory is the home directory of the user.
