...
* <span class="col-hash">6891983 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> C2
* <span class="col-hash">a961cba</span> C1
</pre>
...
<pre class="terminal">
$ git reflog
<span class="col-hash">6891983 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> HEAD@{0}: checkout: moving from feature to main
<span class="col-hash">b2d535d</span> HEAD@{1}: commit: C3
<span class="col-hash">6891983 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> HEAD@{2}: checkout: moving from main to feature
<span class="col-hash">6891983 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> HEAD@{3}: commit: C2
<span class="col-hash">a961cba</span> HEAD@{4}: commit (initial): C1
</pre>
...
* <span class="col-hash">b2d535d (</span><span class="col-branch-local">feature</span><span class="col-hash">)</span> C3
* <span class="col-hash">6891983 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="active-branch">main</span><span class="col-hash">)</span> C2
* <span class="col-hash">a961cba</span> C1
</pre>
...
<pre class="terminal">
$ git log --oneline --all
<span class="col-hash">d3e3264 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> First commit
$ git reflog
<span class="col-hash">d3e3264 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> HEAD@{0}: reset: moving to HEAD^
<span class="col-hash">9071636</span> HEAD@{1}: commit: Second commit
<span class="col-hash">d3e3264 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> HEAD@{2}: commit (initial): First commit
$ git reset --hard 9071636
$ git log --oneline
<span class="col-hash">9071636 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> Second commit
<span class="col-hash">d3e3264</span> First commit
</pre>
