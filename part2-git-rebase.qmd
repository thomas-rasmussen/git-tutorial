...
* <span class="sha1-col">26806c3 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-> </span><span class="active-branch-col">main</span><span class="sha1-col">)</span> C2
<span style="color:red">|</span> * <span class="sha1-col">3aa6d72 (</span><span class="active-branch-col">feature</span><span class="sha1-col">)</span> C4
<span style="color:red">|</span> * <span class="sha1-col">1e8657b</span> C3
<span style="color:red">|/</span>
* <span class="sha1-col">7639344</span> C1
...
<pre class="git-command">
git log --oneline --graph --all
* <span class="sha1-col">d5843e4 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">feature</span><span class="sha1-col">)</span> C4
* <span class="sha1-col">ffd1adb</span> C3
* <span class="sha1-col">26806c3 (</span><span class="active-branch-col">main</span><span class="sha1-col">)</span> C2
* <span class="sha1-col">7639344</span> C1
</pre>
...
$ git log --oneline
<span class="sha1-col">321b893 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">add-new-feature</span><span class="sha1-col">)</span> Refactor to make more efficient
<span class="sha1-col">83f522f</span> Fix bug
<span class="sha1-col">86adade</span> First draft of implementation
<span class="sha1-col">dc71be8 (</span><span class="active-branch-col">main</span><span class="sha1-col">)</span> Initial commit
</pre>
...
<pre class="git-command">
$ git log --oneline
<span class="sha1-col">3df4aa8 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">add-new-feature</span><span class="sha1-col">)</span> Implement feature
<span class="sha1-col">dc71be8 (</span><span class="active-branch-col">main</span><span class="sha1-col">)</span> Initial commit
</pre>
...
* <span class="sha1-col">b744d7b (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Second commit on main branch
<span style="color:red">|</span> * <span class="sha1-col">6f7e6de (</span><span class="active-branch-col">feature</span><span class="sha1-col">)</span> Commit on feature branch
<span style="color:red">|/</span>
* <span class="sha1-col">87d57f0</span> First commit on main branch
</pre>
...
<span class="sha1-col">hint: Resolve all conflicts manually, mark them as resolved with</span>
<span class="sha1-col">hint: "git add/rm <conflicted_files>", then run "git rebase --continue".</span>
<span class="sha1-col">hint: You can instead skip this commit: run "git rebase --skip".</span>
<span class="sha1-col">hint: To abort and get back to the state before "git rebase", run "git rebase --abort".</span>
<span class="sha1-col">hint: Disable this message with "git config set advice.mergeConflict false"</span>
...
* <span class="sha1-col">a0daf9d </span>(<span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch">feature</span><span class="sha1-col">)</span> Commit on feature branch
* <span class="sha1-col">b744d7b (</span><span class="active-branch-col">main</span><span class="sha1-col">)</span> Second commit on main branch
* <span class="sha1-col">87d57f0</span> First commit on main branch
</pre>
...
<pre class="git-command">
$ git log --oneline
<span class="sha1-col">6882f38 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Third commit
<span class="sha1-col">c06bb27</span> Second commit
<span class="sha1-col">ad2c6c5</span> First commit
$ cat file.txt
...
<pre class="git-command">
$ git log --oneline
<span class="sha1-col">b082fad (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Squashed commit
$ cat file.txt
Content of first commit
Content of second commit
Content of third commit
...
* <span class="sha1-col">cb32850 (</span><span class="head-col">HEAD </span><span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Update base code and README
<span style="color:red">|</span> * <span class="sha1-col">03baf98 (</span><span class="active-branch-col">implement-feature</span><span class="sha1-col">)</span> Add info on feature in README
<span style="color:red">|</span> * <span class="sha1-col">2cbc9bf</span> Implement feature
<span style="color:red">|/</span>
* <span class="sha1-col">3bb821e</span> Initial commit
</pre>
...
<pre class="git-command">
$ git log --oneline --graph --all
* <span class="sha1-col">603e19f (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">implement-feature</span><span class="sha1-col">)</span> Implement feature
* <span class="sha1-col">cb32850 (</span><span class="active-branch-col">main</span><span class="sha1-col">)</span> Update base code and README
* <span class="sha1-col">3bb821e</span> Initial commit
</pre>
...
$ git log --oneline
<span class="sha1-col">b93c2a0 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Add README
<span class="sha1-col">5e8e19d</span> Add feature
</pre>
...
<pre class="git-command">
$ git log --oneline
<span class="sha1-col">50f0523 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Add feature
<span class="sha1-col">0bdde57</span> Add README
</pre>
...
$ git log --oneline
<span class="sha1-col">d7c6a64 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Add feature1 and feature2
<span class="sha1-col">06b1273</span> Initial commit
</pre>
...
Untracked files:
  (use "git add <file>..." to include in what will be committed)
        <span style="color:red">feature1.txt</span>
        <span style="color:red">feature2.txt</span>
</pre>
...
$ git rebase --continue
$ git log --oneline
<span class="sha1-col">f81244f (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Add feature2.txt
<span class="sha1-col">2423455</span> Add feature1
<span class="sha1-col">06b1273</span> Initial commit
</pre>
:::
...
This exercise assumes you have read the chapter on `git reflog`, see xxx.
...
$ git commit -am"Third commit"
$ git log --oneline
<span class="sha1-col">8993eb8 (</span><span class="head-col">HEAD</span> <span class="sha1-col">-></span> <span class="active-branch-col">main</span><span class="sha1-col">)</span> Third commit
<span class="sha1-col">1dd5e36</span> Second commit
<span class="sha1-col">cd2c018</span> First commit
</pre>
