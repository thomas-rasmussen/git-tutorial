...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">~</span>
<span class="bash-grey">$ echo > empty_file.txt</span>
</pre>
```
...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">~</span>
<span class="bash-grey">$ echo "Some content" > new_file.txt</span>
</pre>
```
...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">~</span>
<span class="bash-grey">$ echo "Some content" > append_file.txt</span>
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">~</span>
<span class="bash-grey">$ echo "Some more content" >> append_file.txt</span>
</pre>
```
...
```{=html}
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ ls</span>
<span class="bash-grey"><span class="bash-violet">dir_a</span>/ file_a.txt file_c.txt file_e.txt</span>
<span class="bash-grey"><span class="bash-violet">dir_b</span>/ file_b.txt file_d.txt file_f.txt</span>
</pre>
```

By default multiple entries are listed in each line and directories are colorcodes and has a "/" suffix.
...
```{=html}
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/git_repo</span>
<span class="bash-grey">$ ls -a</span>
<span class="bash-grey"><span class="bash-violet">.git</span>/ file_a.txt file_c.txt file_e.txt</span>
<span class="bash-grey">.gitignore file_b.txt file_d.txt file_f.txt</span>
</pre>
```
...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ ls -1</span>
<span class="bash-violet">dir_a</span><span class="bash-grey">/</span>
<span class="bash-violet">dir_b</span><span class="bash-grey">/</span>
<span class="bash-grey">file_a.txt</span>
<span class="bash-grey">file_b.txt</span>
<span class="bash-grey">file_c.txt</span>
<span class="bash-grey">file_d.txt</span>
<span class="bash-grey">file_e.txt</span>
<span class="bash-grey">file_f.txt</span>
</pre>
```
...
<span class="bash-grey">file_a.txt</span>
<span class="bash-grey">file_b.txt</span>
<span class="bash-grey">$ mkdir new-folder</span>
<span class="bash-grey">$ mkdir "new-folder"</span>
<span class="bash-grey">$ ls -1</span>
<span class="bash-violet">new-folder</span><span class="bash-grey">/</span>
<span class="bash-violet">'new folder'</span><span class="bash-grey">/</span>
<span class="bash-grey">file_a.txt</span>
<span class="bash-grey">file_b.txt</span>
</pre>
...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">~</span>
<span class="bash-grey">$ pwd</span>
<span class="bash-grey">/c/absolute/path/to/home/directory</span>
</pre>
```
...
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ ls</span>
<span class="bash-grey">file_a.txt file_b.txt</span>
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ rm file_a.txt</span>
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ ls</span>
<span class="bash-grey">file_b.txt</span>
</pre>
...
<pre class="bash-terminal">
<span class="bash-green">user_id@computer_id</span> <span class="bash-pink">MINGW64</span> <span class="bash-gold">/c/some/dir</span>
<span class="bash-grey">$ start .</span>
</pre>
```
