...
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/directory</span>
$
</pre>
...
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/some directory</span>
$
</pre>
...
<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/dir</span>
$ cd subfolder
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/dir/subfolder</span>
$
</pre>

#### Example - Change to parent directory

We can change the working directory to the parent directory by setting `DIR` to ".."0

<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/dir</span>
$ cd ..
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to</span>
$
</pre>
...
<pre class="bash-terminal"">
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/dir_a</span>
$ cd ../dir_b
<span class="bash-color">user_id@computer_id MINGW64 /c/path/to/dir_b</span>
$
</pre>
...
<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/current/cd/dir</span>
$ cd -
<span class="bash-color">user_id@computer_id MINGW64 /c/previous/cd/dir</span>
$
</pre>
...
<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/current/dir</span>
$ cd ~
<span class="bash-color">user_id@computer_id MINGW64 ~</span>
$ cd -
<span class="bash-color">user_id@computer_id MINGW64 /c/current/dir</span>
...
<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/some/dir</span>
$ ls
...
<pre class="bash-terminal">
<span class="bash-color">user_id@computer_id MINGW64 /c/some/git_repo</span>
$ ls -a
