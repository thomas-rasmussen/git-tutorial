...
* <span class="col-hash">82b0b49 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">test</span><span class="col-hash">)</span> Add more changes to file.txt
* <span class="col-hash">0242a6a</span> Add changes to file.txt
* <span class="col-hash">ee99f60 (</span><span class="col-branch-local">main</span><span class="col-hash">)</span> Add file.txt
</pre>
...
* <span class="col-hash">82b0b49 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">,</span> <span class="col-branch-local">test</span><span class="col-hash">)</span> Add more changes to file.txt
* <span class="col-hash">0242a6a</span> Add changes to file.txt
* <span class="col-hash">ee99f60</span> Add file.txt
</pre>
...
$ git log --oneline --all --graph
* <span class="col-hash">9b14dc1 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> Fix bug in file1.txt
<span class="col-log-graphline1">|</span> * <span class="col-hash">f9bcc9e</span> <span class="col-hash">(</span><span class="col-branch-local">update-file2</span><span class="col-hash">)</span> Update file2.txt
<span class="col-log-graphline1">|/</span>
* <span class="col-hash">c2c50b0</span> Add file1.txt and file2.txt
</pre>
...
*   <span class="col-hash">e553fcb (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> Merge branch 'update-file2'
<span class="col-log-graphline1">|\</span>
<span class="col-log-graphline1">|</span> * <span class="col-hash">f9bcc9e (</span><span class="col-branch-local">update-file2</span><span class="col-hash">)</span> Update file2.txt
* <span class="col-log-graphline1">|</span> <span class="col-hash">9b14dc1</span> Fix bug in file1.txt
<span class="col-log-graphline1">|/</span>
* <span class="col-hash">c2c50b0</span> Add file1.txt and file2.txt
</pre>
...
$ git log --oneline --all --graph
* <span class="col-hash">10c4145 (</span><span class="col-head">HEAD</span> <span class="col-hash">-></span> <span class="col-branch-local">main</span><span class="col-hash">)</span> Add new content to file.txt on branch main
<span class="col-log-graphline1">|</span> * <span class="col-hash">9e600a9 (</span><span class="col-branch-local">new-branch</span><span class="col-hash">)</span> Add new content to file.txt on branch new-branch
<span class="col-log-graphline1">|/</span>
* <span class="col-hash">1593545</span> Add file.txt
</pre>
